...
els.csvText.value = `区分,指標,値,前期比,備考
営業,売上高,125000000,前年比 +12.4%,主力SaaSプランの契約継続率が高く堅調に推移
営業,営業利益,18400000,前年比 +8.1%,広告投資を継続しつつも粗利改善で吸収
営業,経常利益,17650000,前年比 +7.6%,為替影響は限定的で安定推移
営業,新規契約数,428,前月比 +16.2%,中小企業向けキャンペーンの反応が良好
営業,解約率,1.8%,前月比 -0.3pt,オンボーディング改善施策が継続的に寄与
CS,問い合わせ一次応答時間,14分,前月比 -22%,休日シフト最適化により大幅短縮
CS,顧客満足度,4.6 / 5,前月比 +0.2,サポート品質アンケートで高評価を維持
開発,月間デプロイ回数,56,前月比 +11,軽量な改善を小刻みに反映する運用へ移行
開発,平均復旧時間,32分,前月比 -18分,監視通知ルールの整理で初動を高速化
開発,未解決バグ件数,23,前月比 -9,優先度の高い表示崩れと出力不具合を先行解消
マーケ,広告CPA,4380円,前月比 -12%,指名検索流入の増加が効率改善に寄与
マーケ,自然検索流入,84200,前月比 +19%,比較記事と導入事例ページの評価が上昇
運用,月間稼働率,99.97%,目標達成,静的配信主体のため安定運用を継続
